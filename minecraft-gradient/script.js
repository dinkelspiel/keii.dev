...
{
    document.getElementById('savedata').value = `https://keii.dev/minecraft-gradient?savedata=${getSaveData()}`;
...
const savedata = urlParams.get('savedata');
...
if(savedata != null)
{
    try {
        ...
        json.forEach(e => {
            newControlPoints.push(new ControlPoint(e.x, new Color(e.r, e.g, e.b, 255)))
        })
        ...
        document.getElementById('body').insertBefore(createElementFromHTML(html), document.getElementById('body').firstChild)
    }
}
